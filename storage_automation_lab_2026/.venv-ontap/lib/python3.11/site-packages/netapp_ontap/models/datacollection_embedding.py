...
__all__ = ["DatacollectionEmbedding", "DatacollectionEmbeddingSchema"]
__pdoc__ = {
    "DatacollectionEmbeddingSchema.resource": False,
    "DatacollectionEmbeddingSchema.opts": False,
    "DatacollectionEmbedding": False,
}

class DatacollectionEmbeddingSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the DatacollectionEmbedding object"""
...
Example: true """
    ...
    @property
    def resource(self):
        return DatacollectionEmbedding
...
class DatacollectionEmbedding(Resource):

    _schema = DatacollectionEmbeddingSchema
