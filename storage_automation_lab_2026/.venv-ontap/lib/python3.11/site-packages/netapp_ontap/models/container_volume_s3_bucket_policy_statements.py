...
__all__ = ["ContainerVolumeS3BucketPolicyStatements", "ContainerVolumeS3BucketPolicyStatementsSchema"]
__pdoc__ = {
    "ContainerVolumeS3BucketPolicyStatementsSchema.resource": False,
    "ContainerVolumeS3BucketPolicyStatementsSchema.opts": False,
    "ContainerVolumeS3BucketPolicyStatements": False,
}

class ContainerVolumeS3BucketPolicyStatementsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the ContainerVolumeS3BucketPolicyStatements object"""

    actions = marshmallow_fields.List(marshmallow_fields.Str, data_key="actions", allow_none=True)
    r""" The actions field of the container_volume_s3_bucket_policy_statements.
...
* deny """
    ...
    r""" The principals field of the container_volume_s3_bucket_policy_statements.
...
Example: ["user1","group/grp1","nasgroup/group1"] """
    ...
    r""" The resources field of the container_volume_s3_bucket_policy_statements.
...
Example: Full_Access_To_User1! """
    ...
    @property
    def resource(self):
        return ContainerVolumeS3BucketPolicyStatements
...
class ContainerVolumeS3BucketPolicyStatements(Resource):

    _schema = ContainerVolumeS3BucketPolicyStatementsSchema
