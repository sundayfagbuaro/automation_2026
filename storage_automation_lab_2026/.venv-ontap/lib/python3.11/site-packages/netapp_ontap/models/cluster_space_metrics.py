...
__all__ = ["ClusterSpaceMetrics", "ClusterSpaceMetricsSchema"]
__pdoc__ = {
    "ClusterSpaceMetricsSchema.resource": False,
    "ClusterSpaceMetricsSchema.opts": False,
    "ClusterSpaceMetrics": False,
}

class ClusterSpaceMetricsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the ClusterSpaceMetrics object"""
    ...
    r""" The links field of the cluster_space_metrics. """
...
class ClusterSpaceMetrics(Resource):

    _schema = ClusterSpaceMetricsSchema
